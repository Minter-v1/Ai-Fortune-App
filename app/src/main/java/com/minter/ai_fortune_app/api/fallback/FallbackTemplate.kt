...
object FallbackTemplate {
    ...
    fun getMissionFallback(location: String): Pair<String, String> {
        val missions = listOf(
            Pair(
                "오늘의 산책 미션",
                "주변을 천천히 산책하며 좋은 기운을 받아보세요! 스마트폰은 잠시 내려두고 주변 풍경을 감상해보세요 ✨"
            ),
            Pair(
                "힐링 카페 타임",
                "근처 카페에서 따뜻한 차 한 잔과 함께 여유를 즐겨보세요. 좋아하는 음악을 들으며 마음의 평화를 찾아보세요 ☕"
            ),
            Pair(
                "자연과 함께하기",
                "가까운 공원이나 녹지에서 깊게 숨을 쉬어보세요. 나무들과 꽃들을 보며 자연의 에너지를 느껴보세요 🌿"
            ),
            Pair(
                "감사 인사 미션",
                "오늘 만나는 사람들에게 따뜻한 인사를 건네보세요. 작은 미소 하나가 하루를 밝게 만들어 줄 거예요 😊"
            ),
            Pair(
                "작은 친절 실천",
                "주변 사람에게 작은 도움이나 친절을 베풀어보세요. 엘리베이터 버튼을 눌러주거나 문을 잡아주는 것만으로도 충분해요 💝"
            ),
            Pair(
                "맛있는 간식 찾기",
                "근처에서 평소 먹어보지 않은 새로운 간식을 찾아보세요. 새로운 맛의 발견이 작은 행복을 가져다 줄 거예요 🍰"
            ),
            Pair(
                "사진 촬영 미션",
                "오늘의 아름다운 순간을 사진으로 남겨보세요. 하늘, 꽃, 혹은 특별한 장면을 찾아 기록해보세요 📸"
            ),
            Pair(
                "독서 타임",
                "근처 서점이나 도서관에서 관심 있는 책을 찾아보세요. 몇 페이지만 읽어도 새로운 영감을 얻을 수 있을 거예요 📚"
            ),
            Pair(
                "음악 감상하기",
                "좋아하는 음악을 들으며 주변을 둘러보세요. 음악과 함께하는 시간이 마음에 위로가 될 거예요 🎵"
            ),
            Pair(
                "스트레칭 타임",
                "잠시 시간을 내어 몸을 쭉쭉 늘려보세요. 간단한 스트레칭으로 몸과 마음을 가볍게 만들어보세요 🤸‍♀️"
            )
        )
